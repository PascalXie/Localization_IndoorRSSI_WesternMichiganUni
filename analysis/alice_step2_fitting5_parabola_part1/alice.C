...
int main()
{
	...
	variables.push_back(0.1);
	//variables.push_back(160.);
	...
	cout<<"Fitting results : a0 "<<results[0]<<", a1 "<<results[1]<<", a2 "<<results[2]<<endl;
	...
	for(int i=0;i<10;i++)
	{
		...
		double rssit =  results[0] + results[1]*dt + results[2]*dt*dt;
