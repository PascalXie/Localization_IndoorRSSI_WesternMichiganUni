...
void RaisdualTest();
void Analysis(double a0,double a1,double a2, double a3, double min, double max);
...
int main()
{
	...
	string filename2 = "../../alice_step2_fitting4_4polynomial_part1/build/data_step2_polynomial.txt";
	...
	read2>>name>>a2;
	read2>>name>>a3;
	cout<<"Fitting Results : a0 "<<a0<<", a1 "<<a1<<", a2 "<<a2<<", a3 "<<a3<<endl;
	...
	for(int i=0;i<binSize;i++)
	{
		...
		Analysis(a0, a1, a2, a3, current_min, current_max);
	}
...
void Analysis(double a0,double a1,double a2, double a3, double min, double max)
{
	...
	double mean_rssi = a0 + a1*mean_dist + a2*mean_dist*mean_dist + a3*mean_dist*mean_dist*mean_dist;
