...
class NewtonsCostFunction : virtual public UserCostFunction
{
    ...
    public:
		...
		virtual void SetBayesianObstacles(vector<double> obsxs, vector<double> obsys, double sigma, double weight);
	...
	protected:
		...
		// obstacles for bayesian , rooms, walls
		vector<double>	obstacle_obsxs_;
		vector<double> 	obstacle_obsys_;
		double			obstacle_sigma_;
